...
- 日経が**上がれば** → MMは先物を**売る** → 上昇が自然に抑えられる
- 日経が**下がれば** → MMは先物を**買う** → 下落が自然に抑えられる

👉 **相場が安定しやすい。急騰・急落が起きにくいレンジ相場になりやすい。**
""")
    else:
        st.error(f"""
### 🔴 青線はゼロ以下 → ネガティブガンマ環境
...
- 日経が**上がれば** → MMは先物を**買う** → 上昇がさらに加速する
- 日経が**下がれば** → MMは先物を**売る** → 下落がさらに加速する

👉 **相場が荒れやすい。一方向に動き出すと勢いが増しやすい。**
""")
