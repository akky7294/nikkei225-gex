...
MMはデルタをニュートラルに保つため、**相場と逆方向にヘッジ**します。
- 日経が**上がれば** → MMは先物を**売る** → 上昇が打ち消され、**下に戻されやすい**
- 日経が**下がれば** → MMは先物を**買う** → 下落が打ち消され、**上に戻されやすい**

👉 **相場が戻されやすく、レンジ（往来相場）になりやすい。一方向への大きな動きが出にくい。**
""")
    else:
        st.error(f"""
### 🔴 青線はゼロ以下 → ネガティブガンマ環境

MMはデルタをニュートラルに保つため、**相場と同じ方向にヘッジ**します。
- 日経が**上がれば** → MMは先物を**買う** → 上昇がさらに**加速する**
- 日経が**下がれば** → MMは先物を**売る** → 下落がさらに**加速する**

👉 **動いた方向に勢いが増しやすい。トレンドが出やすく、急騰・急落に注意。**
""")
